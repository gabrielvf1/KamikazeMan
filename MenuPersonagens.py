...
def MenuPersonagem():
	...
	img_setas=pygame.image.load('img\MenuPersonagens\Seta_teclado.png')
	def Menu_Personagens(Imagem_Estatica,Escolhendo_personagem,Personagem1,Personagem2,Personagem3,Personagem4,Iniciar_Jogo,quadrado1,quadrado2):
		gameDisplay.blit(Imagem_Estatica,(0,0))
		gameDisplay.blit(Personagem1,(14,125))
		gameDisplay.blit(pygame.transform.scale(Personagem2,(190,246)),(210,125))
		gameDisplay.blit(pygame.transform.scale(Personagem3,(190,246)),(405,126))
		gameDisplay.blit(pygame.transform.scale(Personagem4,(194,246)),(599,127))
		gameDisplay.blit(quadrado1,(600,380))
		gameDisplay.blit(quadrado2,(600,470))
		gameDisplay.blit(pygame.transform.scale(Iniciar_Jogo,(350,80)),(30,400))
		gameDisplay.blit(Escolhendo_personagem,(2,15))
	...
	ImagemJogador_1=0
	ImagemJogador_2=0
	Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1_selecionado,Img_personagem2,Img_personagem3,Img_personagem4,Img_Inciar_jogo,QuadradoPreto1_img,QuadradoPreto2_img,)
		...
		for event in pygame.event.get():
			...
			if event.type==pygame.KEYDOWN:
				...
				if marcacao==1  and event.key == pygame.K_RIGHT:
					Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1,Img_personagem2_selecionado,Img_personagem3,Img_personagem4,Img_Inciar_jogo,QuadradoPreto1_img,QuadradoPreto2_img,)
					marcacao=2
					marcacao_cima_baixo=1
					marcapersonagem=2
				elif marcacao==2 and event.key==pygame.K_RIGHT:
					Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1,Img_personagem2,Img_personagem3_selecionado,Img_personagem4,Img_Inciar_jogo,QuadradoPreto1_img,QuadradoPreto2_img,)
					marcacao=3
					marcacao_cima_baixo=1
					marcapersonagem=3
				elif marcacao==3 and event.key==pygame.K_RIGHT:
					Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1,Img_personagem2,Img_personagem3,Img_personagem4_selecionado,Img_Inciar_jogo,QuadradoPreto1_img,QuadradoPreto2_img,)
					marcacao=4
					marcacao_cima_baixo=1
					marcapersonagem=4
				#Apertando Esquerda
				...
				if marcacao_cima_baixo == 1 and event.key == pygame.K_DOWN:
					Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1,Img_personagem2,Img_personagem3,Img_personagem4,Img_Inciar_jogo_selecionada,QuadradoPreto1_img,QuadradoPreto2_img,)
				...
				if marcapersonagem==1 and event.key==pygame.K_RETURN and marcacao_player==1:
					...
					img1_player1 = "Sprites personagens\Delc_32x32.png"
					Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1_selecionado,Img_personagem2,Img_personagem3,Img_personagem4,Img_Inciar_jogo,QuadradoPreto1_img,QuadradoPreto2_img,)
					...
					img1_player1 = "Sprites personagens\Gabriel_32x32.png"
					Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1,Img_personagem2_selecionado,Img_personagem3,Img_personagem4,Img_Inciar_jogo,QuadradoPreto1_img,QuadradoPreto2_img,)
					...
					img1_player1 = "Sprites personagens\Matheus_32x32.png"
					Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1,Img_personagem2,Img_personagem3_selecionado,Img_personagem4,Img_Inciar_jogo,QuadradoPreto1_img,QuadradoPreto2_img,)
					...
					img1_player1 = "Sprites personagens\Vini_32x32.png"
					Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1,Img_personagem2,Img_personagem3,Img_personagem4_selecionado,Img_Inciar_jogo,QuadradoPreto1_img,QuadradoPreto2_img,)
				...
				if marcapersonagem==1 and event.key==pygame.K_SPACE and marcacao_player==2:
					...
					img2_player2 = "Sprites personagens\Delc_32x32.png"
					Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1_selecionado,Img_personagem2,Img_personagem3,Img_personagem4,Img_Inciar_jogo,QuadradoPreto1_img,QuadradoPreto2_img,)
					...
					Escolhendo_personagem_img_1=Escolhendo_personagem_img_3
					img2_player2 = "Sprites personagens\Gabriel_32x32.png"
					Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1,Img_personagem2_selecionado,Img_personagem3,Img_personagem4,Img_Inciar_jogo,QuadradoPreto1_img,QuadradoPreto2_img,)
					...
					Escolhendo_personagem_img_1=Escolhendo_personagem_img_3
					img2_player2 = "Sprites personagens\Matheus_32x32.png"
					Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1,Img_personagem2,Img_personagem3_selecionado,Img_personagem4,Img_Inciar_jogo,QuadradoPreto1_img,QuadradoPreto2_img,)
					...
					Escolhendo_personagem_img_1=Escolhendo_personagem_img_3
					img2_player2 = "Sprites personagens\Vini_32x32.png"
					Imagem_menu=Menu_Personagens(menu_Img_personagens,Escolhendo_personagem_img_1,Img_personagem1,Img_personagem2,Img_personagem3,Img_personagem4_selecionado,Img_Inciar_jogo,QuadradoPreto1_img,QuadradoPreto2_img,)
